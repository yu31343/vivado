...
HD_PWD='D:/31343/Documents/VivadoFiles/add/add.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addr2b_hex8seg_EGo1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source addr2b_hex8seg_EGo1.tcl -notrace
