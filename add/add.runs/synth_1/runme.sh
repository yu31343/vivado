...
HD_PWD='D:/31343/Documents/VivadoFiles/add/add.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addr2b_hex8seg_EGo1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addr2b_hex8seg_EGo1.tcl
